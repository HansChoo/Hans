...
import ProductDetailRecording from './components/ProductDetailRecording';
import ProductDetailParents from './components/ProductDetailParents';
import ProductDetailMV from './components/ProductDetailMV';
import ProductDetailAlbum from './components/ProductDetailAlbum';
...
const services: Service[] = [
  {
    ...
    icon: <Mic2 className="w-6 h-6 md:w-8 md:h-8" />,
    gradient: 'from-pink-500 to-rose-500',
    link: '#detail-recording'
  },
  {
    id: 'parents',
    title: 'AI 부모님 감사 영상',
  ...
  },
  {
    ...
    icon: <Disc className="w-6 h-6 md:w-8 md:h-8" />,
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-purple-500 selection:text-white">
      ...
      <main>
        ...
        <section id="assistant" className="py-12 md:py-24 px-4 sm:px-6 lg:px-8 relative bg-gradient-to-b from-black to-[#080808]">
        ...
        {/* Services Section */}
        <section id="services" className="pt-10 pb-0 md:pt-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-[#050505]">
          ...
          <div className="max-w-7xl mx-auto mb-16">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-3xl md:text-5xl font-black mb-3 md:mb-4 text-white drop-shadow-[0_0_25px_rgba(168,85,247,0.6)] tracking-tight">
                Our Services
              </h2>
        ...
        {/* AI Song Recording Detail Section */}
        <section id="detail-recording">
          <ProductDetailRecording />
        </section>

        {/* AI Parents Video Detail Section */}
        <section id="detail-parents">
          <ProductDetailParents />
        </section>

        {/* AI Music Video Detail Section */}
        <section id="detail-mv">
          <ProductDetailMV />
        </section>

        {/* AI Album Production Detail Section */}
        <section id="detail-album">
          <ProductDetailAlbum />
        </section>
      </main>
